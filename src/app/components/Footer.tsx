...
const Footer = () => {
  return (
    <div className='bottom-0 left-0 w-full pt-6 flex items-center justify-between flex-col md:flex-row bg-white shadow-lg shadow-gray-400 border-t border-primary rounded-t-2xl  px-5 md:px-20 py-5 gap-5 md:gap-0'>
        <div className="flex flex-col gap-4 items-start">
            ...
            <div className="flex flex-col items-start gap-3">
              ...
              <div className="flex items-center gap-4 flex-wrap">
                <Link href='/chat' className='text-sm md:text-md text-primary font-light'>Chat</Link>
